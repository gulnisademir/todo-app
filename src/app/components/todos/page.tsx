        ...
        return (
          <div className="card-container" key={todo.id}>
            <div>
              ...
              <button
                type="button"
                // onClick={() => (window.location.href = `/components/edit-todo/aski=${todo}?id=${todo.id}&task=${encodeURIComponent(todo.task)}`)}
               onClick={() => (window.location.href = `/components/edit-todo/&?id=${todo.id}&task=${encodeURIComponent(todo.task)}`)}
